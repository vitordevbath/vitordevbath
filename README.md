...
Estudante de eng. de software, mas o diploma tá correndo atrás do trampo, não na frente. Vivo entre backend, automação e infra self-hosted — se dá pra rodar num servidor que eu controlo, eu prefiro assim.

### ▍ No momento

- Construindo um CRM pra aposentar uma planilha que já era um cemitério
- Automatizando bots e fluxos no Discord (registro, cargos, moderação)
- Subindo modelos de IA localmente e plugando em pipeline próprio
- Quebrando minhas próprias máquinas num home lab pra aprender o lado ofensivo
